...
) : FlowUseCase<ImagesToPdfUseCase.Params>() {

    data class Params(val imageUris: List<Uri>, val outputUri: Uri)

    override fun execute(params: Params): Flow<ProcessingProgress> =
        pdfRepository.imagesToPdf(params.imageUris, params.outputUri)
}
